  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <form name="sentMessage" action="/user/save" method="post" id="contactForm" novalidate>
          ...
          <div class="form-group col-xs-12 floating-label-form-group controls">
              ...
              <input type="password" class="form-control" placeholder="PasswordCheck" id="passwordCheck" required data-validation-required-message="Please enter your phone number.">
              <p class="help-block text-danger"></p>
            </div>
          <br>
          <div id="success"></div>
